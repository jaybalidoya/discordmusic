...
module.exports = {
  ...
  run: async function (client, message, args) {
    ...
    if (!channel)return sendError("I'm Sorry but you need to be in a Fortnight Voice Channel to Play Music!", message.channel);
    ...
    if (serverQueue) {
      ...
      .setFooter(`Powered By: Fortnight City Supports `)
    ...
    const play = async (song) => {
      ...
      if (!song) {
        sendError("Paalam Maraming Salamat Sa Pakikinig!.", message.channel)
      ...
      let thing = new MessageEmbed()
      .setAuthor("Fortnigh Radio 101.1 Started Playing Music!", "https://raw.githubusercontent.com/SudhanPlayz/Discord-MusicBot/master/assets/Music.gif")
      .setThumbnail(song.img)
      .setColor("PINK")
      .addField("Name", song.title, true)
      .addField("Duration", song.duration, true)
